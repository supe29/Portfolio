            ...
            <div className="about-sections">
                ...
                <div className="about-right">
                    <div className="about-para">
                        <p>As a data analyst and marketing specialist , I specialize in guiding organizations through the entire data lifecycle – from conceptualization and data collection to analysis, interpretation, and compelling presentation of findings. Whether you're just starting to define your data strategy or seeking to enhance your existing data practices, I'm here to provide tailored solutions at every stage of the journey.My expertise spans a wide range of tools and techniques including Machine Learning, Data Visualization, Big Data Technologies, Data Engineering, Statistical Analysis, Cloud Platforms, Application development etc.</p>
